package com.quanglewangle.peter.newshop;
...
public class ShowList {
    ...
    public class Showlist extends ListActivity implements AsyncTaskCompleteListener<String> {
        ...
        protected void onResume() {
            super.onResume();
            setContentView(R.layout.cupboard_list);
            LoadURL loadUrl = new LoadURL((AsyncTaskCompleteListener<String>) ShowList.this);
                ...
                case R.id.description:
                    ...
                    alert2.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Toast.makeText(getApplicationContext(), "Dialog got:" + value, Toast.LENGTH_SHORT).show();
                            Map o = (HashMap<String, String>) products.get(listPosition);
                            LoadURL loadUrl = new LoadURL(Showlist.this);
